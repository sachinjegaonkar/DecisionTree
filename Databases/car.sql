CREATE TABLE `car` (
  `buying` varchar(20) default NULL,
  `maint` varchar(20) default NULL,
  `doors` varchar(20) default NULL,
  `persons` varchar(20) default NULL,
  `lug_boot` varchar(20) default NULL,
  `safety` varchar(20) default NULL,
  `class` varchar(20) default NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

/* Data for the `car` table  (Records 1 - 500) */

INSERT INTO `car` (`buying`, `maint`, `doors`, `persons`, `lug_boot`, `safety`, `class`) VALUES 
...
/* Data for the `car` table  (Records 501 - 1000) */
...
/* Data for the `car` table  (Records 1001 - 1500) */
...
/* Data for the `car` table  (Records 1501 - 1728) */
