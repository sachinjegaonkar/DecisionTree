...
/* Data for the `mushroom` table  (Records 1 - 500) */

INSERT INTO `mushroom` (`class`, `capshape`, `capsurface`, `capcolor`, `bruises`, `odor`, `gillattachment`, `gillspacing`, `gillsize`, `gillcolor`, `stalkshape`, `stalkroot`, `stalkabovesurface`, `stalkbelowsurface`, `stalkabovecolor`, `stalkbelowcolor`, `veiltype`, `veilcolor`, `ringnumber`, `ringtype`, `sporecolor`, `population`, `habitat`) VALUES 
...
/* Data for the `mushroom` table  (Records 501 - 943) */
