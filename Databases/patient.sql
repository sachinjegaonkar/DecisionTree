CREATE TABLE `patient` (
  `L_CORE` varchar(20) default NULL,
  `L_SURF` varchar(20) default NULL,
  `L_O2` varchar(20) default NULL,
  `L_BP` varchar(20) default NULL,
  `SURF_STBL` varchar(20) default NULL,
  `CORE_STBL` varchar(20) default NULL,
  `BP_STBL` varchar(20) default NULL,
  `COMFORT` varchar(20) default NULL,
  `class` varchar(20) default NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

/* Data for the `patient` table  (Records 1 - 90) */

INSERT INTO `patient` (`L_CORE`, `L_SURF`, `L_O2`, `L_BP`, `SURF_STBL`, `CORE_STBL`, `BP_STBL`, `COMFORT`, `class`) VALUES 
